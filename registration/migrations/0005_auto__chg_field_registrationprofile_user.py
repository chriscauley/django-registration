...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'registration_registrationprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['user.User'], unique=True))
    ...
    models = {
        ...
        u'registration.registrationprofile': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'RegistrationProfile'},
            'activated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "'ACTIVATION_KEY'", 'max_length': '40'}),
